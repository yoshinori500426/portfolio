...
public class CreateTableDAO extends DAO {
	...
	public int createTable() {
		int line = 0;
		String[] ExistCheckSQL = new String[10];
		...
		ExistCheckSQL[9] = "SELECT * FROM information_schema.tables WHERE table_name = 'stock_list_all'";
		String[] CreateSQL = new String[10];
		...
		CreateSQL[5] = "CREATE TABLE PURODUCT_STOCK(STOCK_INFO_DATE VARCHAR(7),PRODUCT_NO VARCHAR(10),STOCK_QTY NUMERIC(8,0),W_STOCK_QTY NUMERIC(8,0),T_NYUKO NUMERIC(8,0),T_SYUKO NUMERIC(8,0),T_NYUKA NUMERIC(8,0),T_SYUKA NUMERIC(8,0),UP_DATE VARCHAR(10)NOT NULL,PRIMARY KEY(STOCK_INFO_DATE,PRODUCT_NO))";
		...
		CreateSQL[9] = "CREATE VIEW STOCK_LIST_ALL (\"PRODUCT_NO\", \"DELIVERY_DATE\", \"ORDER_NO\", \"CUSTOMER_NO\", \"CUSTOMER_NAME\", \"PURCHASE_ORDER_QTY\", \"SUPPLIER_NO\", \"SUPPLIER_NAME\", \"ORDER_QTY\") AS (SELECT PO.PRODUCT_NO, PO.DELIVERY_DATE, PO.PO_NO, PO.CUSTOMER_NO, CM.CUSTOMER_NAME, PO.ORDER_QTY, NULL, NULL, NULL FROM PURCHASE_ORDER PO INNER JOIN CUSTOMER_MASTER CM ON PO.CUSTOMER_NO = CM.CUSTOMER_NO WHERE PO.FIN_FLG = '0' UNION SELECT OT.PRODUCT_NO, OT.DELIVERY_DATE, OT.ORDER_NO, NULL, NULL, NULL, OT.SUPPLIER_NO, SM.SUPPLIER_NAME, OT.ORDER_QTY FROM ORDER_TABLE OT INNER JOIN SUPPLIER_MASTER SM ON OT.SUPPLIER_NO = SM.SUPPLIER_NO WHERE OT.FIN_FLG = '0')";
		...
		CommentSQL[5][4] = "COMMENT ON COLUMN PURODUCT_STOCK.W_STOCK_QTY is '現在倉庫在庫数';";
		CommentSQL[5][5] = "COMMENT ON COLUMN PURODUCT_STOCK.T_NYUKO is '当月入庫数';";
		CommentSQL[5][6] = "COMMENT ON COLUMN PURODUCT_STOCK.T_SYUKO is '当月出庫数';";
		CommentSQL[5][7] = "COMMENT ON COLUMN PURODUCT_STOCK.T_NYUKA is '当月入荷数';";
		CommentSQL[5][8] = "COMMENT ON COLUMN PURODUCT_STOCK.T_SYUKA is '当月出荷数';";
		CommentSQL[5][9] = "COMMENT ON COLUMN PURODUCT_STOCK.UP_DATE is '更新日';";
		...
		String[] DeleteSQL = new String[10];
	...
	public int insertProductMasterTable() {
		...
		SQL[0] = "INSERT INTO PRODUCT_MASTER VALUES('0000000100', 'あまおう(苺)', '000100', 40, 80, 3, 2, 'A-01-1', 170, NULL, '2020/04/30', '000020')";
		SQL[1] = "INSERT INTO PRODUCT_MASTER VALUES('0000000108', '白鳳(桃)', '000110', 60, 120, 3, 2, 'A-01-2', 170, NULL, '2020/04/30', '000020')";
		SQL[2] = "INSERT INTO PRODUCT_MASTER VALUES('0000000116', '佐藤錦(さくらんぼ)', '000120', 80, 160, 3, 2, 'A-01-3', 170, NULL, '2020/04/30', '000020')";
		SQL[3] = "INSERT INTO PRODUCT_MASTER VALUES('0000000124', 'デコポン(柑橘)', '000130', 90, 180, 3, 2, 'A-01-4', 170, NULL, '2020/04/30', '000020')";
		SQL[4] = "INSERT INTO PRODUCT_MASTER VALUES('0000000132', '巨峰(ぶどう)', '000140', 100, 200, 3, 2, 'A-01-5', 170, NULL, '2020/04/30', '000020')";
		SQL[5] = "INSERT INTO PRODUCT_MASTER VALUES('0000000140', '大根', '000150', 110, 220, 3, 2, 'B-01-1', 170, NULL, '2020/04/30', '000020')";
		SQL[6] = "INSERT INTO PRODUCT_MASTER VALUES('0000000148', '南瓜', '000160', 120, 240, 3, 2, 'B-01-2', 170, NULL, '2020/04/30', '000020')";
		SQL[7] = "INSERT INTO PRODUCT_MASTER VALUES('0000000156', '人参', '000170', 130, 260, 3, 2, 'B-01-3', 170, NULL, '2020/04/30', '000020')";
		try {
			Connection con = getConnection();
			PreparedStatement st = null;
			for (int i = 0; i < SQL.length; i++) {
	...
	public int insertPurchaseOrderTable() {
		...
		SQL[19] = "INSERT INTO PURCHASE_ORDER VALUES('PO-00020', 'A1000', '0000000132', 60, '2023/06/29', '', '0', '2023/06/20', '000020')";
		...
		SQL[23] = "INSERT INTO PURCHASE_ORDER VALUES('PO-00024', 'A0400', '0000000140', 60, '2023/06/29', '', '0', '2023/06/20', '000020')";
	...
	public int insertPuroductStockTable() {
		...
		SQL[0] = "INSERT INTO PURODUCT_STOCK VALUES('2023/05', '0000000100', 200, 50, 100, 50, 100, 50, '2023/05/31')";
		SQL[1] = "INSERT INTO PURODUCT_STOCK VALUES('2023/06', '0000000100', 200, 50, 100, 50, 110, 60, '2023/06/01')";
		SQL[2] = "INSERT INTO PURODUCT_STOCK VALUES('2022/03', '0000000108', 200, 50, 100, 50, 100, 50, '2023/05/31')";
		SQL[3] = "INSERT INTO PURODUCT_STOCK VALUES('2022/04', '0000000108', 200, 50, 100, 50, 110, 60, '2023/06/01')";
		SQL[4] = "INSERT INTO PURODUCT_STOCK VALUES('2023/05', '0000000116', 200, 50, 100, 50, 100, 50, '2023/05/31')";
		SQL[5] = "INSERT INTO PURODUCT_STOCK VALUES('2023/06', '0000000116', 200, 50, 100, 50, 110, 60, '2023/06/01')";
		SQL[6] = "INSERT INTO PURODUCT_STOCK VALUES('2022/03', '0000000124', 200, 50, 100, 50, 100, 50, '2023/05/31')";
		SQL[7] = "INSERT INTO PURODUCT_STOCK VALUES('2022/04', '0000000124', 200, 50, 100, 50, 110, 60, '2023/06/01')";
		SQL[8] = "INSERT INTO PURODUCT_STOCK VALUES('2023/05', '0000000132', 200, 50, 100, 50, 100, 50, '2023/05/31')";
		SQL[9] = "INSERT INTO PURODUCT_STOCK VALUES('2023/06', '0000000132', 200, 50, 100, 50, 110, 60, '2023/06/01')";
		SQL[10] = "INSERT INTO PURODUCT_STOCK VALUES('2022/03', '0000000140', 200, 50, 100, 50, 100, 50, '2023/05/31')";
		SQL[11] = "INSERT INTO PURODUCT_STOCK VALUES('2022/04', '0000000140', 200, 50, 100, 50, 110, 60, '2023/06/01')";
		SQL[12] = "INSERT INTO PURODUCT_STOCK VALUES('2023/05', '0000000148', 200, 50, 100, 50, 100, 50, '2023/05/31')";
		SQL[13] = "INSERT INTO PURODUCT_STOCK VALUES('2023/06', '0000000148', 200, 50, 100, 50, 110, 60, '2023/06/01')";
		SQL[14] = "INSERT INTO PURODUCT_STOCK VALUES('2022/03', '0000000156', 200, 50, 100, 50, 100, 50, '2023/05/31')";
		SQL[15] = "INSERT INTO PURODUCT_STOCK VALUES('2022/04', '0000000156', 200, 50, 100, 50, 110, 60, '2023/06/01')";
		try {
			Connection con = getConnection();
			PreparedStatement st = null;
			for (int i = 0; i < SQL.length; i++) {
	...
	public int insertOrderTable() {
		...
		SQL[27] = "INSERT INTO ORDER_TABLE VALUES('OD-2305-00028', '000160', '0000000148', 10, '2023/06/30', NULL, '', 0, '0', '000020', '2023/06/23', '000010')";
		...
		SQL[31] = "INSERT INTO ORDER_TABLE VALUES('OD-2305-00032', '000170', '0000000156', 10, '2023/06/30', NULL, '', 0, '0', '000020', '2023/06/23', '000010')";
		try {
			Connection con = getConnection();
			PreparedStatement st = null;
			for (int i = 0; i < SQL.length; i++) {
