			...
			<div>
				...
				<form action="Login.action" method="post">
					...
					<div class="row">
						...
						<p class="col-xs-5">：<input type="number" style="width: 250px" name="userId" id="userId" class="inputRequired" data-inputRequired="false" 
												min="0" max="999999" step="1" onkeyup="javascript: this.value = this.value.slice(0, 6);" 
												onchange="javascript: this.value = this.value==0?'':('000000'+this.value).slice(-6);docheck();" 
					...
					<div class="row">
						...
						<p class="col-xs-5">：<input type="password" style="width: 250px" name="password" id="password" class="inputRequired" data-inputRequired="false" 
												onchange="docheck();" placeholder="8-20文字(英数構成、大文字1以上)"></p>
						<div class="col-xs-1"></div>
					</div>
					<br>
					<div class="row">
